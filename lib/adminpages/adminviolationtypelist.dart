...
class AdminViolationTypeList extends StatefulWidget {
  String adminEmail = "";
  AdminViolationTypeList({Key? key, required this.adminEmail}) : super(key: key);
  final String title = "Violation Type List";

  // final authuser = FirebaseAuth.instance.currentUser!;

  @override
  State<AdminViolationTypeList> createState() => _AdminViolationTypeList();
}

class _AdminViolationTypeList extends State<AdminViolationTypeList> {
  _AdminViolationTypeList();

  final _adminviolationlistformkey = GlobalKey<FormState>();
                ...
                child: Column(children: [
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        print("Going to Admin Violation List Page");
                      ...
                      child: FractionallySizedBox(
                        ...
                        child: Column(children: [
                          Expanded(
                            flex: 1,
                            child: Form(
                              key: _adminviolationlistformkey,
                              child: Row(
                                children: [
                                  Expanded(
                                    flex: 3,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: searchon
                                    ? StreamBuilder<List<ViolationType>>(
                                        stream: searchViolationTypes(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          if (snapshot.hasData) {
                                            final violationtypes = snapshot.data!;

                                            return ListView(
                                              scrollDirection: Axis.vertical,
                                              children: violationtypes
                                                  .map(buildViolationTypeTile)
                                                  .toList(),
                                            );
                                          } else {
                                            return const Center(
                          ...
                          Expanded(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    gotoadmincreateviolationtypepage(context);
                                  },
