...
class AdminGuardList extends StatefulWidget {
  String adminEmail = "";
  AdminGuardList({Key? key, required this.adminEmail}) : super(key: key);
  final String title = "Guard List";

  // final authuser = FirebaseAuth.instance.currentUser!;

  @override
  State<AdminGuardList> createState() => _AdminGuardList();
}

class _AdminGuardList extends State<AdminGuardList> {
  _AdminGuardList();

  final _adminguardlistformkey = GlobalKey<FormState>();
                        ...
                        child: Column(children: [
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: searchon
                                    ? StreamBuilder<List<Guard>>(
                                        stream: searchGuards(
                                            searchcategory: searchcategory,
                                            guardsearchkey: adminsearchkey),
                          ...
                          Expanded(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    gotoadmincreateguardpage(context);
                                  },
