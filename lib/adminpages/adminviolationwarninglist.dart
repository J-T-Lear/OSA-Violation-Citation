...
class AdminViolationWarningList extends StatefulWidget {
  String adminEmail = "";
  AdminViolationWarningList({Key? key, required this.adminEmail})
      : super(key: key);
  final String title = "Violation Warning List";

  // final authuser = FirebaseAuth.instance.currentUser!;

  @override
  State<AdminViolationWarningList> createState() =>
      _AdminViolationWarningList();
}

class _AdminViolationWarningList extends State<AdminViolationWarningList> {
  _AdminViolationWarningList();
                                  ...
                                  Expanded(
                                      ...
                                      child: Padding(
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () {
                                            gotoadminviolationhistorylistpage(
                                                context, widget.adminEmail);
                                          },
                                          child: const Padding(
                                            padding: EdgeInsets.symmetric(
                              ...
                              child: Center(
                                child: searchon
                                    ? StreamBuilder<List<StudentViolation>>(
                                        stream: searchWarningViolations(
