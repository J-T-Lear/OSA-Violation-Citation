...
class AdminCreateViolationType extends StatefulWidget {
  AdminCreateViolationType({Key? key}) : super(key: key);
  final String title = "Create Violation Type";

  // final authuser = FirebaseAuth.instance.currentUser!;

  @override
  State<AdminCreateViolationType> createState() => _AdminCreateViolationType();
}

class _AdminCreateViolationType extends State<AdminCreateViolationType> {
  _AdminCreateViolationType();

  final _admincreateviolationtypeformkey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
          child: buildCreateViolationTypeForm(
              context,
              _admincreateviolationtypeformkey,
