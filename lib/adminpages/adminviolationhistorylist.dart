...
class AdminViolationHistoryList extends StatefulWidget {
  String adminEmail = "";
  AdminViolationHistoryList({Key? key, required this.adminEmail}) : super(key: key);
  final String title = "Violation History List";

  // final authuser = FirebaseAuth.instance.currentUser!;

  @override
  State<AdminViolationHistoryList> createState() => _AdminViolationHistoryList();
}

class _AdminViolationHistoryList extends State<AdminViolationHistoryList> {
  _AdminViolationHistoryList();
                              ...
                              child: Center(
                                child: searchon
                                    ? StreamBuilder<List<StudentViolation>>(
                                        stream: searchResolvedViolations(
